            ...
            <div class="card rounded">
              <div class="card-body">               
                <div class="d-flex align-items-center justify-content-between mb-2">
                    <div>
                        <img class="wd-100 rounded-circle" src="{{ (!empty($profileData->photo)) ? url('uploads/images/'.$profileData->photo) : url('uploads/no-image1.jpeg')}}" alt="profile">
                        ...
                        <form class="forms-sample" action="{{route('admin.profile.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                             ...
                             <div class="mb-3">
                                ...
                                <input type="email" class="form-control" name="email" value="{{$profileData->email}}" placeholder="Email">
                            </div>                            
                            ...
                            <div class="mb-3">
                             ...
                             <div class="mb-3">
                               <img id="showimage" class="rounded-circle wd-80" src="{{(!empty($profileData->photo)) ? url('uploads/images/'.$profileData->photo) : url('uploads/no-image1.jpeg')}}" alt="">
                            </div>
