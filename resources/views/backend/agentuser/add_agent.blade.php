            ...
            <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="myForm" class="forms-sample" action="{{route('store.agent')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3 form-group">
                                <label for="roles" id="roles"  class="form-label">Select Role</label>
