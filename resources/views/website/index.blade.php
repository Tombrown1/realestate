@extends('website.site')
@section('pageTitle', 'Home')
@section('content')


        <!-- banner-section -->
       @include('website.body.banner')
        <!-- banner-section end -->
            ...
            <div class="auto-container">
                <div class="inner-box clearfix">
                    ...
                    <div class="btn-box pull-right">
                        ...
                        <a href="index-2.html" class="theme-btn btn-one">Buy Properties</a>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="content_block_1">
                            <div class="content-box">
                                ...
                                <div class="download-btn">
                                    <a href="index-2.html" class="app-store">
                                        <i class="fab fa-apple"></i>
                                        <p>Download on</p>
                                        <h4>App Store</h4>
                                    </a>
                                    <a href="index-2.html" class="google-play">
